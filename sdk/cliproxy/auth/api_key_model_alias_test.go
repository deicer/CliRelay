...
func TestAPIKeyModelAlias_MultipleProviders(t *testing.T) {
	cfg := &internalconfig.Config{
		...
		OpenCodeGoKey: []internalconfig.OpenCodeGoKey{
			{APIKey: "opencode-key", Models: []internalconfig.OpenCodeGoModel{{Name: "kimi-k3", Alias: "k3"}}},
		},
	...
	_, _ = mgr.Register(ctx, &Auth{ID: "opencode-auth", Provider: "opencode-go", Attributes: map[string]string{"api_key": "opencode-key"}})
