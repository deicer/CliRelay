...
func GetOpenAIModels() []*ModelInfo {
	return []*ModelInfo{
		...
		},
		{
			...
			Description:         "Flagship model in OpenAI's GPT 5.6 series, strong at complex reasoning, coding, and agentic workflows.",
		...
		},
		{
			...
			Description:         "Balanced model in OpenAI's GPT 5.6 series, positioned between the flagship Sol tier and the cost-efficient Luna tier.",
			ContextLength:       1050000,
			MaxCompletionTokens: 128000,
			SupportedParameters: []string{"tools"},
			Thinking:            &ThinkingSupport{Levels: []string{"low", "medium", "high", "xhigh"}},
		},
		{
			...
			Description:         "Fast, cost-efficient model in OpenAI's GPT 5.6 series, suited for high-volume, latency-sensitive tasks.",
			ContextLength:       1050000,
			MaxCompletionTokens: 128000,
			SupportedParameters: []string{"tools"},
			Thinking:            &ThinkingSupport{Levels: []string{"low", "medium", "high", "xhigh"}},
